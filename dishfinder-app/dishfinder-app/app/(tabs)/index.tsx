      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.filterRow}>
             ...
             >
                <Text style={[styles.filterText, sortBy === 'relevance' && styles.filterTextActive]}>Relevance</Text>
             </TouchableOpacity>
             ...
             >
                <Text style={[styles.filterText, sortBy === 'distance' && styles.filterTextActive]}>Nearest</Text>
             </TouchableOpacity>
             ...
             >
                <Text style={[styles.filterText, sortBy === 'price' && styles.filterTextActive]}>Lowest Price</Text>
             </TouchableOpacity>
          </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  container: { flex: 1, paddingHorizontal: 20, backgroundColor: '#121212' },
  header: { paddingTop: 40, paddingBottom: 20 },
  title: { fontSize: 32, fontWeight: '900', color: '#fff', letterSpacing: -1 },
  titleAccent: { color: '#FF5A5F' },
  subtitle: { fontSize: 14, color: '#B0B0B0', marginTop: 6, marginBottom: 24 },
  searchContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#1E1E1E', borderRadius: 16, paddingHorizontal: 16, height: 56, borderWidth: 1, borderColor: '#333' },
  ...
  loadingContainer: { position: 'absolute', top: 140, right: 30 },
  errorBox: { backgroundColor: 'rgba(255, 90, 95, 0.1)', borderWidth: 1, borderColor: 'rgba(255, 90, 95, 0.3)', padding: 16, borderRadius: 12, marginBottom: 16 },
  errorText: { color: '#FF5A5F', fontWeight: 'bold' },
  errorSubtext: { color: '#FF5A5F', opacity: 0.8, fontSize: 12, marginTop: 4 },
  filterRow: { flexDirection: 'row', gap: 10, marginTop: 16 },
  filterPill: { paddingVertical: 6, paddingHorizontal: 12, borderRadius: 20, backgroundColor: '#1E1E1E', borderWidth: 1, borderColor: '#333' },
  filterPillActive: { backgroundColor: 'rgba(255, 90, 95, 0.2)', borderColor: '#FF5A5F' },
  filterText: { color: '#aaa', fontSize: 13, fontWeight: '600' },
  filterTextActive: { color: '#FF5A5F', fontWeight: '800' }
});
